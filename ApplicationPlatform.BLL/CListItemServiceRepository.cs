...
{
    public class CListItemServiceRepository:BaseServiceRepository<CListItem>,ICListItemServiceRepository
    {
        /// <summary>
        /// 构造函数，通过仓储工厂调用dal中的具体的仓储
        /// </summary>
        /// <param name="currentRepository"></param>
        public CListItemServiceRepository()
            : base(RepositoryFactory.CListItemRepository)
        {
        }
    }
}